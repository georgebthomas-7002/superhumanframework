        ...
        <div className="max-w-6xl mx-auto px-4 text-center relative z-10">
          ...
          >
            <div className="inline-block mb-6 px-4 py-2 rounded-full bg-white/10 border border-white/20 text-sm font-bold backdrop-blur-sm">
              <span className="text-[#faaa68]">Moving from "Compliance Officer" to "Culture Architect"</span>
            </div>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-black mb-6">
              Ready to Stop Being the "Fun Police"?
            </h2>
            <p className="text-xl md:text-2xl mb-8 text-gray-300">
              Get the <span className="font-bold text-[#f65625]">HR Playbook</span> and start building a culture where people don't just work—they thrive.
            </p>
            <button
            ...
            <p className="mt-6 text-gray-400">
              Join thousands of HR leaders who've ditched the policies and started loving people.
            </p>
          </motion.div>
        </div>
      </section>
